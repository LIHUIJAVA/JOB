...
public class SellComnInvSub {
	...
	private String sellSnglNums;//发货单标识
	...
	//新增销售单子表编码、委托结算单主表、委托代销子表标识、销售出库单编码、销售出库单子表标识、退货单主表
	private Long sellSnglSubId;//销售单子表标识
	private String outWhsId;//销售出库单编码
	private Long outWhsSubId;//销售出库单子表标识
	...
	public String getSellSnglNums() {
		return sellSnglNums;
	}
	public void setSellSnglNums(String sellSnglNums) {
		this.sellSnglNums = sellSnglNums;
	}
	...
	public Long getSellSnglSubId() {
		return sellSnglSubId;
	}
	public void setSellSnglSubId(Long sellSnglSubId) {
		this.sellSnglSubId = sellSnglSubId;
	}
	...
	public Long getOutWhsSubId() {
		return outWhsSubId;
	}
	public void setOutWhsSubId(Long outWhsSubId) {
		this.outWhsSubId = outWhsSubId;
	}
}
