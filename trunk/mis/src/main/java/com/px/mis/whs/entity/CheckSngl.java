...
public class CheckSngl {
    ...
    // 盘点单子表
    private List<CheckSnglSubTab> cSubTabList;
    ...
    public List<CheckSnglSubTab> getcSubTabList() {
        return cSubTabList;
    }

    public void setcSubTabList(List<CheckSnglSubTab> cSubTabList) {
        this.cSubTabList = cSubTabList;
    }
